<?php define('BASE_URL', 'http://192.168.1.2:80/web'); ?>
...
<head>
  ...
  <link rel="canonical" href="http://192.168.1.2:80/web">
  ...
  <link rel="stylesheet" href="<?php echo BASE_URL; ?>/assets/css/brute.css" >
