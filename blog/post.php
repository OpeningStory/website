...
if ( file_exists($file_path) ) {
	...
	$content = '
		...
		<a href="http://192.168.1.2:80/web/blog/">home page</a> to select a different post.</p>';
}
        	...
        	<div class="the-content">
          	...
          	?>
        		...
        		<p class='large-margin-top text-small text-color-secondary'>
        			<a href="http://192.168.1.2:80/web/blog/">&larr; Index</a> <span class="nav-separator">/</span> Published on <?php echo $date; ?>
        		</p>
