...
<main>
    ...
    <div class="container-small">
      <div class="row">
        <div class="col-100">
        	<h1>Talking to myself, and you</h1>
        </div>
      </div>
    </div>
  </section>
						...
						for ($year = $current_year; $year >= $first_post_year; $year--) {
							...
							foreach ($files_array as $file) {
								...
								if ( $post_year == $year ) {
									...
									echo '
										<div class="blog-list-item row-box-reveal-hover">
											<a href="post.php?post='.$filename_no_ext.'"><p class="blog-list-item__title">'.$post_title.'</p></a>
